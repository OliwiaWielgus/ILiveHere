 ...
 @Override
    ...
    private void handleSignInResult(Task<GoogleSignInAccount> completedTask){
        try{
            ...
            Toast.makeText(MainActivity.this, "Signed In Succuessfully", Toast.LENGTH_SHORT).show();
            FirebaseGooogleAuth(acc);
        }
        ...
        mAuth.signInWithCredential(authCredential).addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                if(task.isSuccessful()){
                    Toast.makeText(MainActivity.this, "Succuessful", Toast.LENGTH_SHORT).show();
    ...
    public void toMapActivity(View view){
        Intent nextIntent = new Intent(getApplicationContext(), MapsActivity.class);
